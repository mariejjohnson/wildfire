...
def stack_bands(yr, roi):
    ...
    gedi = ee.Image('users/nlang/ETH_GlobalCanopyHeight_2020_10m_v1')
...
if __name__ == '__main__':
    is_authorized()
    # Step 1: upload points to GEE
    points = 'projects/ee-mariejohnson/assets/gedi/sentinel/random_point_10' # upload to GEE prior to running
    # Step 2: change names: random points , run number, date (if applicable)
    years_ = [2020]
    pref = 'bands_19FEB2024_R10' # file prefix
    ...
    # Step 2: Make sure all other functions are commented out, then run this function
    ...
    # comment out
    csv = '/home/marie/EcoRes/GEDI/extracts/sentinel/band_extracts/bands_19FEB2024_R10_2020.csv' # change date
    ...
    out_csv = '/home/marie/EcoRes/GEDI/extracts/sentinel/prepped/prepped_19FEB2024_R10_2020.csv'
    # Step 5:
    ...
    training_data = 'projects/ee-mariejohnson/assets/gedi/sentinel/prepped_19FEB2024_R10_2020' #  generated for the missions unburned? YES projects/ee-mariejohnson/assets/gedi/inference
    # I think I have to create this image collection manually on EE (yes)
    image_coll = 'projects/ee-mariejohnson/assets/gedi/sentinel/canopy_height_19FEB2024_R10'
    ...
    # out_img = 'canopy_height_mission_no_fire_19FEB2024_R10' # predicted height (either burned or unburned depending on what you put for clipped
    out_img = 'canopy_height_crazy_horse_19FEB2024_R10' # predicted height (either burned or unburned depending on what you put for clipped
    # Step 9:
    export_prediction(out_img, training_data, image_coll, clip, [2020])

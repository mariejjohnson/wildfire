...
if __name__ == '__main__':
    is_authorized()
    points = 'projects/ee-mariejohnson/assets/inference/random_points_observed_2k_R10' # upload to GEE prior to running
    ...
    years_ = [2019]
    pref = 'bands_observed_15JAN2024_2k_R10' # file prefix

    roi = 'projects/ee-mariejohnson/assets/gedi/inference/wildCH' # don't change
    # Extracts bands of the points that is was given
    ...
    # comment out
    csv = '/home/marie/EcoRes/GEDI/extracts/observed/bands_observed_15JAN2024_2k_R10_2019.csv' # change run
    ...
    out_csv = '/home/marie/EcoRes/GEDI/extracts/observed/prepped_observed_15JAN2024_2k_R10_2019.csv'
    ...
    # Step 8: uncomment: don't need to change clip, but change out image
    training_data = 'projects/ee-mariejohnson/assets/gedi/inference/prepped_observed_15JAN2024_2k_R10_2019' #  generated for the missions unburned? YES projects/ee-mariejohnson/assets/gedi/inference
    # I think I have to create this image collection manually on EE (yes)
    image_coll = 'projects/ee-mariejohnson/assets/gedi/inference/canopy_height_15JAN2024_2k_R10'
    ...
    out_img = 'canopy_height_crazy_horse_15JAN2024_2k_R10' # predicted height (either burned or unburned depending on what you put for clipped
    # Step 9:
    export_prediction(out_img, training_data, image_coll, clip, [2019])
    # Step 10: Re-run export prediction for crazy horse (only doing crazy horse)
# ========================= EOF =================================================

...
# '/home/marie/alisal/aviris/data/burns/caveGeo.shp'] # Cave fire
    ...
    shp = '/home/marie/alisal/aviris/data/jesusita/0.shp' # Jesusita fire
    # shp = '/home/marie/alisal/aviris/data/0.shp' # Alisal
    # oshp = '/home/marie/alisal/aviris/data'
    icsv = '/home/marie/alisal/aviris/data/jesusita/intersect_jesusita.csv'  # matches exact geometry intersection

...
if __name__ == '__main__':
    is_authorized()
    # I'm re-using the original random points from the first run so all processing will be done the same way with november runs
    # this should technically have _1 on it but it's already uploaded
    ...
    years_ = [2019]
    pref = 'bands_15NOV2023_40k_R10' # file prefix
    ...
    # comment out
    csv = '/home/marie/EcoRes/GEDI/extracts/bands_15NOV2023_40k_R10_2019.csv' # change date
    ...
    out_csv = '/home/marie/EcoRes/GEDI/extracts/prepped_15NOV2023_2019_40k_R10.csv'
    # Step 5:
    ...
    training_data = 'projects/ee-mariejohnson/assets/gedi/inference/prepped_15NOV2023_2019_40k_R10' #  generated for the missions unburned? YES projects/ee-mariejohnson/assets/gedi/inference
    # I think I have to create this image collection manually on EE (yes)
    image_coll = 'projects/ee-mariejohnson/assets/gedi/inference/canopy_height_15NOV2023_R10'
    ...
    # out_img = 'canopy_height_mission_no_fire_15NOV2023_R10' # predicted height (either burned or unburned depending on what you put for clipped
    out_img = 'canopy_height_crazy_horse_15NOV2023_R10' # predicted height (either burned or unburned depending on what you put for clipped
    # Step 9:
